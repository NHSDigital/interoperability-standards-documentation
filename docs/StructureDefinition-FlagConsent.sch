...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Consent">
      <sch:assert test="count(f:extension[@url = 'https://fhir.nhs.uk/England/StructureDefinition/Extension-ConsentCreateSummary']) &lt;= 1">extension with URL = 'https://fhir.nhs.uk/England/StructureDefinition/Extension-ConsentCreateSummary': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.nhs.uk/England/StructureDefinition/Extension-ConsentRemoveSummary']) &lt;= 1">extension with URL = 'https://fhir.nhs.uk/England/StructureDefinition/Extension-ConsentRemoveSummary': maximum cardinality of 'extension' is 1</sch:assert>
